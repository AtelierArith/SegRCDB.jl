...
# ╔═╡ ef49be3d-9e7b-4399-a85c-ac346bdda250
begin
...
# ╔═╡ 964ee944-9905-43da-8308-94d009e50217
md"""

Based on the following parameters described in `make_SegRCDB.sh` not (`SegRCDB_params.py`) we would like to define structs(/types) named `SegRCDBRuntimeConfig` and `SegRCDBParameterSearchConfig` which are something like classes in terms of Python syntax.
...
# ╔═╡ 5e22bd11-18ee-4057-a75f-f386ecb29597
...
# ╔═╡ dbefff56-5f7a-11ee-10ed-8f643aa3e136
...
# ╔═╡ 35b5b1e2-461a-47d6-be8e-b7536fc8d322
md"""
# Implement Parameter search in Julia
"""

# ╔═╡ e5394c20-cda5-48ad-be9b-d69f3bac5d3a
@doc Exponential

# ╔═╡ a22a3011-a9f6-4f75-a7bb-a156eac3fa58
begin
    function uniform(
...
# ╔═╡ 8f331430-3cbc-4b43-9001-396103e2a287
begin
...
# ╔═╡ 23866903-d5b0-4fd3-a374-daab82e943f3
begin
    rng = Xoshiro(seed)
    gray = 0
    vertex_number = 3
    param_dir_root = joinpath(save_root, "param")
    for c in 1:numof_classes
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "79b20750479f06af9a1f3f8ff970a9369fa5aae4"
